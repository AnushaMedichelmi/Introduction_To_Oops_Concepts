...
namespace StudentDatabase
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            /*studentRecord[0] = new Student("Anusha", "Medichelmi", "CSE", 21, 90);
                studentRecord[1] = new Student("Lavanya", "Reddaboina", "CSE", 22, 93);
                studentRecord[2] = new Student("Pravallika", "Bandla", "Civil", 22, 88);
                studentRecord[3] = new Student("Preethi", "Chetkuri", "ECE", 21, 82);
                studentRecord[4] = new Student("Aish", "Vuppala", "ECE", 20, 85);
            ...
            Console.WriteLine("Thank You! Haha!");
            Console.ReadLine();
        }
    }
}
