...
namespace PracticeOnOops
{
    class Program
    {
        ...
        {
            Student student = new Student(1,"Anusha",21,90);
            Cse cse = new Cse(2, "Lavanya", 22, 94);
            Cse cse1 = new Cse(3, "Pravallika", 20, 95);
            Ece ece = new Ece(1, "Preethi", 23, 95);
            Ece ece1 = new Ece(2, "Shruthi", 21, 90);
            Eee eee = new Eee(1, "Aish", 20, 85);
            Eee eee1 = new Eee(2, "Pavani", 22, 80);
            student.Display();
