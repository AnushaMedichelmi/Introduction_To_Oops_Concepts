...
namespace InheritanceAndPolymorphism
{
    class Program
    {
        static void Main(string[] args)
        {
             ...
             *
             */
            Post post = new Post("First Post","Anusha",true);
            ImagePost image = new ImagePost("Unity", "Anusha", "image.jpg", true);
            VideoPost video = new VideoPost("Unity", "Anshu", "UnityEngine.mp4", 14.30f, true);
