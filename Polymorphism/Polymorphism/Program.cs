...
namespace Polymorphism
{
    class Program
    {
        ...
        {
            Account account = new Account("Anusha",100000); // Creating Account object
            SavingsAccount savings = new SavingsAccount("Lavanya", 120000); // Creating Savings Account object
            CurrentAccount currentAccount = new CurrentAccount("Bheem", 190000); // Creating currentAccount object
